...
export default function SideBar({ handleLogout, setFriendMenu, friendMenu }) {
    return (
        <Nav as='ul' navbar className={friendMenu?"flex-column p-0 me-5 position-relative vh-100 sticky-top border-start":"flex-column p-0 me-5 position-relative vh-100 sticky-top border-start border-end"} style={{'z-index':'1100'}}>
